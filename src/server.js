...
app.listen(port, () => {
  ...
  routes.forEach(route => {
    ...
    let methodColor;
    if (methods.includes('GET')) methodColor = 'green';
    else if (methods.includes('POST')) methodColor = 'blue';
    else if (methods.includes('PUT') || methods.includes('PATCH')) methodColor = 'yellow';
    else if (methods.includes('DELETE')) methodColor = 'red';
