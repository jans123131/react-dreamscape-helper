          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 p-8 md:p-12">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-[#64381b]">Origins</h3>
              </div>
              <p className="text-gray-700 leading-relaxed">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-[#64381b]">Brand</h3>
              </div>
              <p className="text-gray-700 leading-relaxed">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-[#64381b]">Production</h3>
              </div>
              <p className="text-gray-700 leading-relaxed">
          ...
          <div className="p-8 md:p-12 bg-[#f8f4f1]/50 border-t border-gray-100">
            <div className="flex items-center justify-center">
              ...
              <p className="text-lg font-medium text-[#64381b] italic">
                "Building on our heritage to create an exceptional future"
              </p>
            </div>
          </div>
        </motion.section>
