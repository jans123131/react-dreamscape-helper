              ...
              {showNutritionInfo && (
                <div className="mb-4 bg-[#96cc39]/10 p-3 rounded-lg inline-block">
                  <p className="text-sm font-medium text-[#700100]">
                    ...
                    <span className="ml-1 text-gray-600">par portion</span>
                  </p>
                </div>
              )}
              ...
              <div className="min-h-[200px]">
                ...
                {activeTab === 'description' && (
                  ...
                  >
                    ...
                    {productData.category === 'dattes-fraiches' && (
                      <p className="mt-4">
                    ...
                    {productData.category === 'figues-sechees' && (
                      <p className="mt-4">
                        Ces figues sont délicatement séchées selon des méthodes traditionnelles tunisiennes, préservant leurs saveurs naturelles et leurs bienfaits nutritionnels. Récoltées à maturité, elles conservent toutes leurs qualités gustatives.
                      </p>
                    )}
                    {productData.category === 'cafe-dattes' && (
                      <p className="mt-4">
                        Ce café de noyaux de dattes est une alternative naturelle sans caféine au café traditionnel, offrant des notes douces et légèrement caramélisées. Une spécialité tunisienne aux vertus digestives reconnues.
                      </p>
                    )}
                    {productData.category === 'sucre-dattes' && (
                      <p className="mt-4">
                        Notre sucre de dattes est obtenu par déshydratation et broyage minutieux de dattes de première qualité. Il conserve les minéraux, vitamines et fibres naturellement présents dans les fruits.
                      </p>
                    )}
                    {productData.category === 'sirop-dattes' && (
                      <p className="mt-4">
                        Ce sirop est un concentré naturel de saveurs obtenu par extraction soigneuse des jus de dattes sélectionnées. Un nectar ambré, légèrement visqueux et intensément parfumé.
                      </p>
                    )}
                  </motion.div>
                )}
                ...
                {activeTab === 'ingredients' && (
                  ...
                  >
                    ...
                    <p className="mt-6 text-gray-600 text-sm italic">
                      {productData.category === 'dattes-fraiches' || productData.category === 'dattes-transformees' ? 
                        ...
                        "Produit 100% naturel, sans additifs ni conservateurs. Conditionné dans un environnement contrôlé pour préserver sa qualité et ses bienfaits."}
                    </p>
                  </motion.div>
                )}
