                  ...
                  <div key={index} className="text-center group">
                    <div className="mb-2">
                      {stat.label === "Revendeur" && (
                        <Globe className="w-7 h-7 md:w-6 md:h-6 mx-auto text-[#96cc39] group-hover:scale-110 transition-transform" />
                      )}
                      {stat.label === "Producteur/Partenaire Affiliés" && (
                        <Factory className="w-7 h-7 md:w-6 md:h-6 mx-auto text-[#96cc39] group-hover:scale-110 transition-transform" />
                      )}
                    </div>
                    <div className="text-[22px] md:text-2xl font-bold text-[#64381b] mb-1">
                      {Math.floor(stat.current)}
                      {stat.suffix}
                    </div>
                    <div className="text-[12px] md:text-xs text-gray-500">
                      {stat.label === "Revendeur" ? "Revendeur" : "Producteur Affiliés"}
                    </div>
                  </div>
                ))}
              </div>
